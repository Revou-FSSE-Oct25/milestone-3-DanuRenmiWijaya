    ...
    return (
        <form className="flex flex-col gap-4" onSubmit={handleSubmit(handlePaymentForm)}>
            <div className='flex flex-col gap-1'>
                ...
                <input className="border-b border-gray-200 py-2 out;ine-none text-sm" type="text" id="cardHolder" placeholder="Danu Renmi Wijaya" {...register("cardHolder")} />
                {errors.cardHolder && (
            ...
            <div className='flex flex-col gap-1'>
                ...
                <input className="border-b border-gray-200 py-2 out;ine-none text-sm" type="text" id="cardNumber" placeholder="123456789123" {...register("cardNumber")} />
                {errors.cardNumber && (
            ...
            <div className='flex flex-col gap-1'>
                ...
                <input className="border-b border-gray-200 py-2 out;ine-none text-sm" type="text" id="expirationDate" placeholder="o1/25" {...register("expirationDate")} />
            ...
            <div className='flex flex-col gap-1'>
                ...
                <input className="border-b border-gray-200 py-2 out;ine-none text-sm" type="text" id="cvv" placeholder="123" {...register("cvv")} />
                {errors.cvv && (
