    ...
    return (
        <div className="flex flex-col gap-8 items-center justify-center mt-12">
            ...
            <div className='w-full flex flex-col lg:flex-row gap-16'>
                ...
                {activeStep === 1 ? (
                    cart.map(item=>(
                        <div className="flex items-center justify-between" key={item.id+item.selectedSize+item.selectedColor}>
                            <div className="flex gap-8">
                                ...
                                <div className="flex flex-col justify-between">
                                    <div className="flex flex-col gap-1">
                                        <p className="text-sm font-mrdium">{item.name}</p>
                            ...
                            <button onClick={()=>removeFormCart(item)} className="w-8 h-8 rounded-full bg-red-100 hover:bg-red-200 transition-all duration-300 text-red-400 flex items-center justify-center cursor-pointer">
                ...
                <p className="text-sm text-gray-500">Pleas fill in the shipping form to continue</p>
                        )}
                </div>
