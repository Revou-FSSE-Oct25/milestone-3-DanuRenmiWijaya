                ...
                <div className='flex flex-col gap-4'>
                    <div className='flex justify-between text-sm'>
                        ...
                        <p className="font-medium">
                            $
                            {cartItems.reduce((acc,item)=>acc+item.price*item.quantity,
                        0).toFixed(2)}
                        </p>
                    </div>
                    <div className='flex justify-between text-sm'>
                        <p className="text-grey-500">Discount(10%)</p>
                        <p className="font-medium">$10</p>
                    </div>
                    <div className='flex justify-between text-sm'>
                        <p className="text-grey-500">Shipping Fee</p>
                        <p className="font-medium">$10</p>
                    </div>
                    <hr className="border-gray-200"/>
                     <div className='flex justify-between'>
                        <p className="text-grey-800 font-semibold">Total</p>
                        <p className="font-medium">${cartItems.reduce((acc,item)=>acc+item.price*item.quantity,
                        0).toFixed(2)}
                        </p>
                    </div>
                </div>
